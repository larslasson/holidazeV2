...
$establishmentsList = file_get_contents('./client/src/data/establishments.json');
...
file_put_contents('./client/src/data/establishments.json', $jsonData);
?>
<?php header("Location: http://localhost:3000/admin"); ?>
