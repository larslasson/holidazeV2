...
$enquiriesList = file_get_contents('./client/src/data/enquiries.json');
...
file_put_contents('./client/src/data/enquiries.json', $jsonData);
?>
<?php header("Location: http://localhost:3000/establishments"); ?>